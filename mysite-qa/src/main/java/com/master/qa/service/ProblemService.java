...
import com.master.qa.dao.ProblemDao;
...
public class ProblemService {
	 ...
	 * @Description 分页 + 最新回答List
	 * @Date 2021/4/27 20:57
	 * @Author by Zhao.J
	 */
	public Page<Problem> newList(String lableid , int page, int rows){
		Pageable pageable = PageRequest.of(page-1, rows);
		return problemDao.findNewListByLableId(lableid, pageable);
	}

	/**
	 * @Classname ProblemService
	 * @Description 分页 + 最热回答List
	 * @Date 2021/4/27 20:57
	 * @Author by Zhao.J
	 */
