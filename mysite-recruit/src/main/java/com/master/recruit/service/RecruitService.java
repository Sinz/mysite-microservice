package com.master.recruit.service;
...
public class RecruitService {
	 ...
	 * @Description 最新推荐
	 * @Date 2021/4/27 17:18
	 * @Author by Zhao.J
	 */
	public List<Recruit> newListRecruit(String state){
		return recruitDao.findTop2ByStateOrderByCreatetime(state);
	}
