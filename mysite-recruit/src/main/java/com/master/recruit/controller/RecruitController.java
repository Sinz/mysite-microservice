...
import com.master.recruit.service.RecruitService;
...
public class RecruitController {
	...
	@ApiOperation("newList: 最新推荐")
	@RequestMapping(value = "/search/newlist", method = RequestMethod.GET)
	public Result newList(){
		return new Result(true,StatusCode.OK,"查询成功",recruitService.newListRecruit("1"));
	}

	@ApiOperation("recommend: 职位推荐")
	@RequestMapping(value = "/search/recommend", method = RequestMethod.GET)
	public Result recommend(){
		return new Result(true,StatusCode.OK,"查询成功", recruitService.recommendRecruit("1"));
	}
